...
function Services() {
  const services = [
    ...
    },
    {
      ...
      link: "https://calendly.com/vedichealingwellness/greeva-basti-neck-therapy-clone-1?back=1&month=2025-04",
    },
    {
      icon: <Waves className="w-full h-full" />,
      ...
      link: "https://calendly.com/vedichealingwellness/shirodhara-clone?back=1&month=2025-04",
    },
    {
      icon: <Waves className="w-full h-full" />,
      ...
      iconClassName: "text-purple-600",
      bgGradient: "bg-gradient-to-br from-purple-50/95 to-violet-50/95",
      link: "https://calendly.com/vedichealingwellness/greeva-basti-neck-therapy-clone?back=1&month=2025-04",
    },
    {
